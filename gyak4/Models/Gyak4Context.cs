...
namespace gyak4.Models;

public partial class Gyak4Context : DbContext
{
    public Gyak4Context()
    {
    }

    public Gyak4Context(DbContextOptions<Gyak4Context> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=gyak4.database.windows.net;Initial Catalog=gyak4;User ID=florab;Password=Password123");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Course>(entity =>
        {
            entity.HasKey(e => e.CourseSk).HasName("PK__Course__C92D8C48EA1F5B80");
        ...
        {
            entity.HasKey(e => e.DayId).HasName("PK__Day__BF3DD8255ACC6788");
        ...
        {
            entity.HasKey(e => e.EmployementId).HasName("PK__Employem__BFBFF0762EB1756C");
        ...
        {
            entity.HasKey(e => e.InstructorSk).HasName("PK__Instruct__9D017A282CE46CCD");
        ...
        {
            entity.HasKey(e => e.LessonSk).HasName("PK__Lesson__B08512E2F4316A71");
        ...
        {
            entity.HasKey(e => e.RoomSk).HasName("PK__Room__328616CFB9804B83");
        ...
        {
            entity.HasKey(e => e.StatusId).HasName("PK__Status__C8EE20431C980F67");
        ...
        {
            entity.HasKey(e => e.TimeId).HasName("PK__Time__E04ED96786C85471");
